...
-- ===== MAIN =====
    ...
    local function createLocationEntry(locationData)
        ...
        tpBtn.MouseButton1Click:Connect(function()
            ...
            if v then
                ...
                jumpOnce() -- <== tambah baris ini (instant: langsung di tempat baru, tween: setelah selesai)
            end
        end)
    ...
    -- Row Replace Location (di bawah Add/Delete)
    local replaceRow = createTpRow(40)
    replaceRow.BackgroundTransparency = 1

    local replaceBtn = Instance.new("TextButton")
    replaceBtn.Size = UDim2.new(1, -20, 1, -10)
    replaceBtn.Position = UDim2.new(0,10,0,5)
