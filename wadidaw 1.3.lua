...
-- Taruh setelah block LOCAL PLAYER FUNCTIONS (setelah disableInstantOpen())
...
-- Taruh setelah block initAntiAFK()
...
-- Taruh setelah block startCoinAmmo()
...
-- Taruh setelah block startCookLoop()
...
-- Taruh setelah block startScrapLoop()
...
-- Taruh setelah block sacrificeItemToLava()
...
-- Taruh setelah block auraHeartbeatConnection
...
-- Taruh setelah block activateTemporal()
...
-- Taruh setelah block sendWebhookPayload()
...
-- Taruh setelah block getStatusSummary()
...
-- Taruh setelah block scanCampground() (untuk fishing tab)
    ...
    lostChildSec:Button({
        ...
        Callback = function()
            ...
            if hrp then
                ...
                notifyUI("Error", selectedChild.." tidak ditemukan!", 5, "alert-triangle")
            end
        end
    })
    ...
    structureSec:Button({
        ...
        Callback = function()
            ...
            if firePath then
                ...
                notifyUI("Error", "Camp (Fire) tidak ditemukan!", 5, "alert-triangle")
            end
        end
    })
    structureSec:Button({
        ...
        Callback = function()
            ...
            if cultistBase and cultistBase.PrimaryPart then
                ...
                notifyUI("Error", "Cultist Generator Base tidak ditemukan!", 5, "alert-triangle")
            end
        end
    })
    structureSec:Button({
        ...
        Callback = function()
            ...
            if sign then
                ...
                notifyUI("Error", "Stronghold tidak ditemukan!", 5, "alert-triangle")
            end
        end
    })
    structureSec:Button({
        ...
        Callback = function()
            ...
            if diamondChest then
                ...
                notifyUI("Error", "Stronghold Diamond Chest tidak ditemukan!", 5, "alert-triangle")
            end
        end
    })
    structureSec:Button({
        ...
        Callback = function()
            ...
            if caravan and caravan.PrimaryPart then
                ...
                notifyUI("Error", "Caravan tidak ditemukan!", 5, "alert-triangle")
            end
        end
    })
    structureSec:Button({
        ...
        Callback = function()
            ...
            if fairyHRP then
                ...
                notifyUI("Error", "Fairy tidak ditemukan!", 5, "alert-triangle")
            end
        end
    })
    structureSec:Button({
        ...
        Callback = function()
            ...
            if anvil then
                ...
                notifyUI("Error", "Anvil tidak ditemukan!", 5, "alert-triangle")
            end
        end
    })
    -- FISHING TAB
